...
from sample.ap.openfold.data import data_transforms
from sample.ap.openfold.np import residue_constants
from sample.ap.openfold.np.protein import Protein
from sample.ap.openfold.utils import rigid_utils
...
def _process_pdb(pdb_file_path: str, mol_feats=None):
    ...
    final_feats = {
        ...
        'rotmats_1': rotmats_1,
        'trans_1': trans_1,
        'rigids_1': rigids_1.to_tensor_7(),
        'diffuse_mask': torch.ones_like(chain_feats['aatype']),
        "res_mask": processed_feats["bb_mask"],
    }

    # chain_feats['diffuse_mask'] = torch.ones_like(chain_feats['aatype'])
    ...
    #     "diffuse_mask": chain_feats['diffuse_mask'],
    # }
